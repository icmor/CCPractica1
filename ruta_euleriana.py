...
def buscar_camino_euleriano(matriz_adyacencia):
    ...
    # Si no hay vertices elegimos cualquier vértice no aislado
    if inicio == -1:
    ...
    while pila:
        ...
        siguiente = None
        for vecino, arista in enumerate(matriz_adyacencia[vertice_actual]):
            if arista == 1:
                siguiente = vecino
        ...
        if siguiente is None:
            ...
            matriz_adyacencia[vertice_actual][siguiente] = 0
